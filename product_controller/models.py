...
class ProductImage(models.Model):
    ...
    image = models.ForeignKey(Product, related_name='image_product', on_delete=models.CASCADE)
    ...
    def __str__(self):
        return f"{self.product.business.name} - {self.product.name} - {self.name}"
...
class Wish(models.Model):
    ...
    products = models.ManyToManyField(Product, related_name="product_wished",)
